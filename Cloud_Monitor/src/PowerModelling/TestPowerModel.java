...
public class TestPowerModel {
	...
	public static void main(String[] args) {
		...
		String machine_id = "'00:22:19:6D:25:D5'";
		// SetTimestamps
		//	String start_t = "'2011-04-25 20:59:51'";
		//	String end_t = "'2011-04-25 21:14:21'";
		String start_t = "'2011-05-01 13:37:01'";
		String end_t = "'2011-05-01 13:47:57'";

		println("Analysis of start_t: " + start_t + " to: " + end_t);
...
//			}
			...
			//Manual power model
			double[] weights = { 43.85376892893859, 10.172908095481045, 0.000012763642759235027, -0.0000018724102429497473, 0.0000000075520007875256 };
			...
			double avgError = totalError / matrix[0].length;
			...
			println("Number of measurements: " + matrix[0].length);

			System.out.println("Regression Analysis took: " + diff + "ms for "
					+ matrix[0].length + " measurements");
